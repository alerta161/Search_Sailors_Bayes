...
class Search():
    ...
    def draw_map(self, last_know):
        ...
        cv.rectangle(self.img, (SA1_CORNES[0], SA1_CORNES[1]),
...
def main():
    ...
    while True:
        ...
        if choice == "0":
            ...
            results_1, coords_1 = app.conduct_search(2, app.sa3, app.sep3)
            results_2, coords_2 = app.conduct_search(2, app.sa3, app.sep3)
            app.sep1 = 0
            app.sep2 = 0
            app.sep3 = (len(set(coords_1 + coords_2))) / (len(app.sa3) ** 2)
        elif choice == "4":
            results_1, coords_1 = app.conduct_search(2, app.sa1, app.sep1)
            results_2, coords_2 = app.conduct_search(2, app.sa1, app.sep1)
            app.sep3 = 0
        elif choice == "5":
            results_1, coords_1 = app.conduct_search(2, app.sa1, app.sep1)
            results_2, coords_2 = app.conduct_search(2, app.sa3, app.sep3)
        ...
        app.revise_target_probs()  # Bayes formula for updating the probability
        ...
        if results_1 == 'Not Found' and results_2 == 'Not Found':
            print("\nNew Target Probabilities (P) for Search {}:".format(search_num))
            print("P1 = {:.3f}, P2 = {:.3f}, P3 = {:.3f}".format(app.p1, app.p2, app.p3))
        else:
